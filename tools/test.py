...
def parse_args():
    ...
    parser.add_argument(
        ...
        help='job launcher')
    parser.add_argument(
        '--json_file', type=str, default=None, help='eval json file')
...
def main():
    ...
    assert args.out or args.eval or args.format_only or args.show or args.json_file, \
    ...
    if rank == 0:
        ...
        if args.json_file is not None:
            dataset.evaluate_json(args.json_file, args.eval, **kwargs)
            return
        if args.format_only:
