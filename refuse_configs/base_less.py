...
# optimizer
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001, paramwise_options=dict(bbox_head_lr_mult=10., rpn_head_lr_mult=10.))
...
log_level = 'INFO'
work_dir = './rc_work_dirs/base_less'
load_from = '/data1/.torch/models/cascade_rcnn_x101_64x4d_fpn_2x_20181218-5add321e.pth'
resume_from = None
workflow = [('train', 1)]
